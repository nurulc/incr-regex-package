...
function st(arr) {
  return arr.map(_rxprint.printExpr).toArray().join("\n");
}
...
describe("regexp incremental New", function () {
    ...
    if (1) {
      (function () {
        ...
        it("incrRegEx or a{3,} - matchStr new", function () {
          ...
          (0, _chai.expect)(res).to.deep.equal([[true, 3, 'aaa'], _rxtree.MAYBE]);
        });
        it("incrRegEx or a{3,5} - match", function () {
          ...
          (0, _chai.expect)(res).to.deep.equal([true, true, true, true, true, false, _rxtree.DONE]);
        });
        ...
        it("incrRegEx for email - valid 'nuru1.-.choudhury@ey.com'", function () {
          ...
          (0, _chai.expect)(res).to.deep.equal([[true, 24, 'nuru1.-.choudhury@ey.com'], _rxtree.MAYBE]);
        });
        it("incrRegEx for email - valid 'nuru1.-.choudhury@ey.com'", function () {
          (0, _chai.expect)(_incrRegexV.incrRegEx !== undefined).to.be.true;
          var r = (0, _incrRegexV.incrRegEx)(EMAIL);
        ...
        it("incrRegEx for email - invalid 'nurul.t@choudhury.1.2345678901234567890.com' ", function () {
          ...
          (0, _chai.expect)(res).to.deep.equal([[false, 19, 'nurul.t@choudhury.1'], _rxtree.MORE]);
          r.reset();
        ...
        it("incrRegEx for email - invalid (extra @) 'nurul.t@choudhury.ab.2345678901234567890@ey.com' ", function () {
          ...
          (0, _chai.expect)(res).to.deep.equal([[false, 40, 'nurul.t@choudhury.ab.2345678901234567890'], _rxtree.MORE]);
        });
        it("incrRegEx for email - incomplete (last name cannot be more than 8 'commander') 'nurul.t@choudhury.ab.2345678901234567890ey.commander' ", function () {
          ...
          (0, _chai.expect)(res).to.deep.equal([[true, 52, 'nurul.t@choudhury.ab.2345678901234567890ey.commander'], _rxtree.MORE]);
        });
        it("incrRegEx for email - valid 'nurul.t@choudhury.ab.2345678901234567890ey.commande' ", function () {
          ...
          //                      12345678901234567890123456789012345678901234567890123  
          (0, _chai.expect)(res).to.deep.equal([[true, 51, 'nurul.t@choudhury.ab.2345678901234567890ey.commande'], _rxtree.MAYBE]);
        });
        it("incrRegEx for email - valid nurul.choudhury@ey.co.uk", function () {
          ...
          (0, _chai.expect)(res).to.deep.equal([[true, 24, 'nurul.choudhury@ey.co.uk'], _rxtree.MAYBE]);
        });
        ...
        it("incrRegEx pathalogical case /(1|4|5){0,100}(1|3){99,100}(1|6)*(1|0){38}abc/  against '1' * (40,000) + 'abc'", function () {
          ...
          (0, _chai.expect)(res).to.deep.equal([[true, data.length, data], _rxtree.DONE]);
  ...
  describe("simple incr regexp", function () {
    ...
    it("regexp or abc|abd", function () {
      ...
      (0, _chai.expect)(res).to.deep.equal([true, true, true, _rxtree.DONE]);
    });
    ...
    it("regexp or abc|abd", function () {
      ...
      var res = [r.matchStr('abc'), r.state()];
      (0, _chai.expect)(res).to.deep.equal([[true, 3, 'abc'], _rxtree.MORE]);
    });
    ...
    it("incrRegEx or /...\\b\\b../ succeed", function () {
      ...
      /* 			console.log(pr(r));
      			...
      			console.log(pr(r));
      */
      var res = [r.matchStr('   ab'), _rxtree.DONE];
      (0, _chai.expect)(res).to.deep.equal([[true, 5, '   ab'], _rxtree.DONE]);
    });
    ...
    it("incrRegEx /...\\b../ succeed", function () {
      (0, _chai.expect)(_incrRegexV.incrRegEx !== undefined).to.be.true;
      var r = /...\b../;
      var res = r.test('   ab');
    ...
    it("incrRegEx or /me a{3}/ - matchStr", function () {
      ...
      (0, _chai.expect)(res).to.deep.equal([[true, 6, 'me aaa'], _rxtree.DONE]);
    });
    it("incrRegEx or /me |a{3}/ - matchStr", function () {
      var r = (0, _incrRegexV.incrRegEx)("me |a{3}");
      var res = [r.matchStr('aa'), r.state()];
      (0, _chai.expect)(res).to.deep.equal([[true, 2, 'aa'], _rxtree.MORE]);

      r.reset();
      res = [r.matchStr('me '), r.state()];
      (0, _chai.expect)(res).to.deep.equal([[true, 3, 'me '], _rxtree.DONE]);

      r.reset();
      res = [r.matchStr('me'), r.state()];
      (0, _chai.expect)(res).to.deep.equal([[true, 2, 'me'], _rxtree.MORE]);
    });
    it("incrRegEx or /(me )|\\w([a-c]{3})?/ - matchStr", function () {
      var r = (0, _incrRegexV.incrRegEx)("(me )|\\w([a-c]{3})?");
      var res = [r.matchStr('xa'), r.state()];
      (0, _chai.expect)(res).to.deep.equal([[true, 2, 'xa'], _rxtree.MORE]);

      r.reset();
      res = [r.matchStr('m'), r.state()];
      (0, _chai.expect)(res).to.deep.equal([[true, 1, 'm'], _rxtree.MAYBE]);

      r.reset();
      res = [r.matchStr('mbac'), r.state()];
      (0, _chai.expect)(res).to.deep.equal([[true, 4, 'mbac'], _rxtree.DONE]);
    ...
    it("incrRegEx or a{3,5} - matchStr", function () {
      ...
      (0, _chai.expect)(res).to.deep.equal([[false, 5, 'aaaaa'], _rxtree.DONE]);
    });
    ...
    it("incrRegEx or a{3,5} - match check cloning", function () {
      ...
      (0, _chai.expect)(res).to.deep.equal([true, true, true, true, false, _rxtree.DONE]);
    ...
    it("incrRegEx for email - valid 'nurul.t@choudhury.ab.2345678901234567890ey.commande' ", function () {
      ...
      (0, _chai.expect)(res).to.deep.equal([[true, str.length, str], _rxtree.MAYBE]);
    });
    ...
    it("incrRegEx for /a(to |be )+done/", function () {
      ...
      //                      123456789012345678901234  
      (0, _chai.expect)(res).to.deep.equal([[true, 'ato be to be be done'.length, 'ato be to be be done'], _rxtree.DONE]);
    });
    it("incrRegEx for /a(to |be )+done/ - success match only 1", function () {
      ...
      //                      123456789012345678901234  
      (0, _chai.expect)(res).to.deep.equal([[true, 'ato done'.length, 'ato done'], _rxtree.DONE]);
    });
    it("incrRegEx for /a(to |be )+done/ - success match only 1", function () {
      (0, _chai.expect)(_incrRegexV.incrRegEx !== undefined).to.be.true;
      var r = (0, _incrRegexV.incrRegEx)("a(to |be )+done");
      ...
      //                      123456789012345678901234  
      (0, _chai.expect)(res).to.deep.equal([[false, 'a'.length, 'a'], _rxtree.MORE]);
    });
    it("incrRegEx for /a(to |be )*done/ - success match only 1", function () {
      (0, _chai.expect)(_incrRegexV.incrRegEx !== undefined).to.be.true;
      var r = (0, _incrRegexV.incrRegEx)("a(to |be )*done");
    ...
    it("incrRegEx for /a(to |be )*done/ - success match only 0", function () {
      ...
      //                      123456789012345678901234  
      (0, _chai.expect)(res).to.deep.equal([[true, 'adone'.length, 'adone'], _rxtree.DONE]);
    });
    it("incrRegEx for /a((to|TO) |(be|BE) ){4,6}done/ success match 5", function () {
      ...
      var res = [r.matchStr(str), r.state()];
      //                      123456789012345678901234  
      (0, _chai.expect)(res).to.deep.equal([[true, str.length, str], _rxtree.DONE]);
    });
    it("incrRegEx for /a((to|TO) |(be|BE) ){4,6}done/ success match 5", function () {
      (0, _chai.expect)(_incrRegexV.incrRegEx !== undefined).to.be.true;
      var r = (0, _incrRegexV.incrRegEx)("a((to|TO) |(be|BE) ){4,6}done");
    ...
    it("incrRegEx for /a(to |be ){4,6}done/ - fail match 3 (to |be )", function () {
      ...
      //                      123456789012345678901234  
      (0, _chai.expect)(res).to.deep.equal([[false, 'ato be to '.length, 'ato be to '], _rxtree.MORE]);
    });
    ...
    it("incrRegEx for /a(to |be ){4,5}done/ should fail - too many", function () {
      ...
      //                      123456789012345678901234  
      (0, _chai.expect)(res).to.deep.equal([[false, 'ato be to be be '.length, 'ato be to be be '], _rxtree.MORE]);
    });
    it("incrRegEx for /a(to |be ){4,5}done/ should fail - too many", function () {
      (0, _chai.expect)(_incrRegexV.incrRegEx !== undefined).to.be.true;
      var r = /a(to |){4,5}done/;
    ...
    it("incrRegEx for /a(to |){4,5}done/ should fail - too few", function () {
      ...
      //                      123456789012345678901234  
      (0, _chai.expect)(res).to.deep.equal([[true, 'ato to to d'.length, 'ato to to d'], _rxtree.MORE]);
    });
    it("incrRegEx for /a(|to ){4,5}done/ should fail - too few", function () {
      (0, _chai.expect)(_incrRegexV.incrRegEx !== undefined).to.be.true;
      var r = (0, _incrRegexV.incrRegEx)("a(to |){4,5}done");
    ...
    it("incrRegEx for /a(to ||be ){4,5}done/ should fail - too few", function () {
      ...
      var res = [r.matchStr('ato done'), r.state()];
      //                      123456789012345678901234  
      (0, _chai.expect)(res).to.deep.equal([[true, 'ato done'.length, 'ato done'], _rxtree.MAYBE]);
    });
    it("incrRegEx for /|to ||be/ success", function () {
      ...
      //                      123456789012345678901234  
      (0, _chai.expect)(res).to.deep.equal([true, _rxtree.MAYBE]);
    }); //\u0000-~‿-⁀⁔︳-︴﹍-﹏＿
    it("incrRegEx for /[\u0000-~‿-⁀⁔︳-︴﹍-﹏＿꜠]+꜠\\.co\\.uk/ - valid", function () {
      ...
      //                      123456789012345678901234  
      (0, _chai.expect)(res).to.deep.equal([[true, S.length, S], _rxtree.MAYBE]);
    });
  });
});