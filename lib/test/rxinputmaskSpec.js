...
var US = [["AL", "Alabama"], ["AK", "Alaska"], ["AS", "American Samoa"], ["AZ", "Arizona"], ["AR", "Arkansas"], ["CA", "California"], ["CO", "Colorado"], ["CT", "Connecticut"], ["DE", "Delaware"], ["DC", "District Of Columbia"], ["FM", "Micronesia"], ["FM", "Federated States Of Micronesia"], ["FL", "Florida"], ["GA", "Georgia"], ["GU", "Guam"], ["HI", "Hawaii"], ["ID", "Idaho"], ["IL", "Illinois"], ["IN", "Indiana"], ["IA", "Iowa"], ["KS", "Kansas"], ["KY", "Kentucky"], ["LA", "Louisiana"], ["ME", "Maine"], ["MH", "Marshall Islands"], ["MD", "Maryland"], ["MA", "Massachusetts"], ["MI", "Michigan"], ["MN", "Minnesota"], ["MS", "Mississippi"], ["MO", "Missouri"], ["MT", "Montana"], ["NE", "Nebraska"], ["NV", "Nevada"], ["NH", "New Hampshire"], ["NJ", "New Jersey"], ["NM", "New Mexico"], ["NY", "New York"], ["NC", "North Carolina"], ["ND", "North Dakota"], ["MP", "Mariana Islands"], ["MP", "Northern Mariana Islands"], ["OH", "Ohio"], ["OK", "Oklahoma"], ["OR", "Oregon"], ["PW", "Palau"], ["PA", "Pennsylvania"], ["PR", "Puerto Rico"], ["RI", "Rhode Island"], ["SC", "South Carolina"], ["SD", "South Dakota"], ["TN", "Tennessee"], ["TX", "Texas"], ["UT", "Utah"], ["VT", "Vermont"], ["VI", "Virgin Islands"], ["VA", "Virginia"], ["WA", "Washington"], ["WV", "West Virginia"], ["WI", "Wisconsin"], ["WY", "Wyoming"]];
...
var states = US.map(function (a) {
    return "(" + a[0] + "-" + a[1] + "|" + a[1] + "-" + a[0] + ")";
}).join("|");
var ssn = "Ssn: \\d{3}-\\d{2}-\\d{4}";
var ext = "( Ext: \\d{1,4})?";
var phonebase = "(\\+\\d{1,3} )?\\(\\d{3}\\)-\\d{3}-\\d{4}";
var phone = "Phone: " + phonebase + ext;
var hwc_phone = "(Home: |Cell: )" + phonebase + "|Work: " + phonebase + ext;
var zip = "Zip: \\d{5}(-\\d{4})?";
var creditcard = "CC: (\\d{4}-){3}\\d{4} exp: (0\\d|1[012])/\\d{2}";
...
describe("RXInputMask Basic", function () {
    ...
    describe("Simple RxInputMask input testing", function () {
        ...
        it("1. pattern /aa[a-zA-Z]+@@\\d+!!/ - add 'aabcd' - expect aaaabcd", function () {
        ...
        it("2. pattern /aa\[a-zA-Z]+@@\\d+!!/ - ins(aabcdeFG - expect(aaaabcdeFG)", function () {
            (0, _chai.expect)(rxi !== undefined).to.be.true;
            rxi.reset();
        ...
        it("3. pattern /aa[a-zA-Z]+@@\\d+!!/ add 'bcdefg' - (expect aabcdefg) then add 'xyz' at pos 3 expect(aabxyzcdefg)", function () {
            (0, _chai.expect)(rxi !== undefined).to.be.true;
            rxi.reset();
            ins(rxi, 'bcdefg');
        ...
        it("4. pattern /aa[a-zA-Z]+@@\\d+!!/ add 'bcdefg@@12' expect'aabcdefg@@12' then add 'xyz' at pos 3", function () {
            (0, _chai.expect)(rxi !== undefined).to.be.true;
            rxi.reset();
            ins(rxi, 'bcdefg@@12');
        ...
        it("5. pattern /aa[a-zA-Z]+@@\\d+!!/ add 'bcdefg12' expect 'aabcdefg@@12' then add 'xyz' at pos 3..6", function () {
            (0, _chai.expect)(rxi !== undefined).to.be.true;
            rxi.reset();
            ins(rxi, 'bcdefg12');
            (0, _chai.expect)(rxi._getValue()).to.deep.equal("aabcdefg@@12");
        ...
        it("6. pattern /aa[a-zA-Z]+@\\d+!!/ add 'bcdefg' - expect 'aabcdefg' then skipFixed expect 'aabcdefg@@'", function () {
            (0, _chai.expect)(rxi !== undefined).to.be.true;
            rxi.reset();
            ins(rxi, 'bcdefg');
            (0, _chai.expect)(rxi._getValue()).to.deep.equal("aabcdefg");
        ...
        it("8. pattern /aa[a-zA-Z]+@@\d+!!/ add 'bcdefg@@12!' expect('aabcdefg@@12!!') then selsect pos 4,10 ('defg@@1') input 'xyz' one character at a time ", function () {
            (0, _chai.expect)(rxi !== undefined).to.be.true;
            rxi.reset();
            ins(rxi, 'bcdefg@@12!');
            (0, _chai.expect)(rxi._getValue()).to.deep.equal("aabcdefg@@12!!");
    ...
    describe("Fixed RxInputMask input testing", function () {
        ...
        it("1. Fixed pattern /\\(\\d{3}\)-\\d{3}-\\d{4}/ 1", function () {
            ...
            (0, _chai.expect)(rxi._getValue()).to.equal((0, _incrRegexV.convertMask)("(914)-735-9843"));
        ...
        it("2 Fixed pattern /\\(\\d{3}\)-\\d{3}-\\d{4}/ delete (1,4)", function () {
            ...
            rxi.select(1, 4);
            rxi.backspace();
            (0, _chai.expect)(rxi.getValue()).to.equal((0, _incrRegexV.convertMask)("(735)-984-3___"));
        ...
        it("2a Fixed pattern /\\(\\d{3}\)-\\d{3}-\\d{4}/ delete (1,4)", function () {
            ...
            (0, _chai.expect)(rxi._getValue()).to.equal((0, _incrRegexV.convertMask)("(147)-359-843"));
            (0, _chai.expect)(rxi.getRawValue()).to.equal((0, _incrRegexV.convertMask)("147359843"));
            rxi.select(1, 1);
            ins(rxi, '9');
            (0, _chai.expect)(rxi._getValue()).to.equal((0, _incrRegexV.convertMask)("(914)-735-9843"));
            rxi.select(1, 4);
        ...
        it("3 Fixed pattern /\\(\\d{3}\)-\\d{3}-\\d{4}/ delete (1,4) insert 914552", function () {
            (0, _chai.expect)(rxi !== undefined).to.be.true;
            rxi.reset();
            var r = ins(rxi, "9147359843");
            rxi.select(1, 4);
            rxi.backspace();
            (0, _chai.expect)(rxi.getValue()).to.equal((0, _incrRegexV.convertMask)("(735)-984-3___"));
            (0, _chai.expect)(rxi.getRawValue()).to.equal((0, _incrRegexV.convertMask)("7359843"));
            ins(rxi, "9");
            (0, _chai.expect)(rxi._getValue()).to.equal((0, _incrRegexV.convertMask)("(973)-598-43"));
            ins(rxi, "87");
            (0, _chai.expect)(rxi._getValue()).to.equal((0, _incrRegexV.convertMask)("(987)-735-9843"));
            (0, _chai.expect)(rxi.selection).to.deep.equal({ start: 6, end: 6 });
        });
        it("5 Fixed pattern /\\(\\d{3}\)-\\d{3}-\\d{4}/ delete (6,10) insert 9147359843", function () {
            (0, _chai.expect)(rxi !== undefined).to.be.true;
            rxi.reset();
            var r = ins(rxi, "9147359843");
            rxi.select(6, 10);
    ...
    describe("Check MaskedInput complex regex", function () {
        var rxi = new _RXInputMask.RXInputMask({ pattern: /\+\(\d{3}\)-\d{3}-\d{4}|#\d{3}\.\d{3}X?YZ| ?\d{3}---\d{4}\./ });
        it("0. Fixed pattern /\\+\\(\\d{3}\\)-\\d{3}-\\d{4}|#\\d{3}\.\\d{3}X?YZ| ?\\d{3}---\\d{4}\\./", function () {
            (0, _chai.expect)(rxi !== undefined).to.be.true;
            rxi.reset();
            var r = ins(rxi, "1");
            //console.log(rxi.minCharsList());
            (0, _chai.expect)(rxi.getValue()).to.equal((0, _incrRegexV.convertMask)("1__---____."));
            (0, _chai.expect)(rxi.pattern.minChars()).to.equal((0, _incrRegexV.convertMask)("__---____."));
            rxi.setSelection(SEL(1, 1));
            (0, _chai.expect)(rxi.selection).to.deep.equal({ start: 1, end: 1 });
            rxi.setValue((0, _incrRegexV.convertMask)("1__---____."));
            (0, _chai.expect)(rxi.pattern.getFirstEditableAtOrAfter(0)).to.equal(0);
            var start = rxi.selection.start,
                end = rxi.selection.end;
            (0, _chai.expect)(start).to.equal(end);
            ...
            rxi.reset();
            ins(rxi, "+914735984");
            (0, _chai.expect)(rxi.getValue()).to.equal((0, _incrRegexV.convertMask)("+(914)-735-984_"));
            rxi.setSelection(SEL(0, 1));
            //console.log("****** tracker: ", rxi.pattern.getInputTracker());
            (0, _chai.expect)(rxi.pattern.getFirstEditableAtOrAfter(0)).to.equal(0);

            (0, _chai.expect)(rxi.selection.end).to.equal(2);
            (0, _chai.expect)(rxi.isDone()).to.equal("MORE");
            (0, _chai.expect)(rxi.pattern.getFirstEditableAtOrAfter(rxi.selection.end)).to.equal(2);
        });
    });
    describe("Check MaskedInput complex regex- minCharsList", function () {
        var rxi = new _RXInputMask.RXInputMask({ pattern: /To|Be|Or|Not|Zo(12|23?)? be/ });
        //rxi = new RXInputMask({pattern: /To/ });
        it("0. Fixed pattern /To|Be|Or|Not|Zo(123)? be/", function () {
            (0, _chai.expect)(rxi !== undefined).to.be.true;
            (0, _chai.expect)(rxi.pattern.matcher.current.length).to.equal(1);
            (0, _chai.expect)(rxi.minCharsList(true)).to.deep.equal(['To', "Be", 'Or', 'Not', 'Zo be', 'Zo12 be', 'Zo2 be', 'Zo23 be'].map(_incrRegexV.convertMask));
        });
        it("1. Fixed pattern /To|Be|Or|Not|Zo(123)? be/", function () {
            (0, _chai.expect)(rxi !== undefined).to.be.true;
            (0, _chai.expect)(rxi.pattern.matcher.current.length).to.equal(1);
            (0, _chai.expect)(rxi.minCharsList()).to.deep.equal(['To', "Be", 'Or', 'Not', 'Zo? be'].map(_incrRegexV.convertMask));
        });
        var rxi1 = new _RXInputMask.RXInputMask({ pattern: /To|Be|Or|Not|Zo(23[a-z])* be/ });
        it("2. Fixed pattern /To|Be|Or|Not|Zo[a-z]* be/", function () {
            (0, _chai.expect)(rxi1 !== undefined).to.be.true;
            (0, _chai.expect)(rxi1.pattern.matcher.current.length).to.equal(1);
            (0, _chai.expect)(rxi1.minCharsList(true)).to.deep.equal(['To', "Be", 'Or', 'Not', 'Zo be', "Zo23a̲* be"].map(_incrRegexV.convertMask));
        });
    });
    //complexRx
    describe("Check MaskedInput complex regex- minCharsList", function () {
        var rxi = new _RXInputMask.RXInputMask({ pattern: new RegExp([states, ssn, phone, zip, creditcard, "Email: " + emails].join("|")) });
        //rxi = new RXInputMask({pattern: /To/ });
        it("0. Fixed pattern /To|Be|Or|Not|To[a-z]* be/", function () {
            (0, _chai.expect)(rxi !== undefined).to.be.true;
            var r = ins(rxi, "a");
            //console.log(rxi.minCharsList());
            (0, _chai.expect)(rxi.pattern.matcher.current.length).to.equal(10);
            (0, _chai.expect)(rxi.minCharsList(true)).to.deep.equal(['AL-Alabama', 'Alabama-AL', 'AK-Alaska', 'Alaska-AK', 'AS-American Samoa', 'American Samoa-AS', 'AZ-Arizona', 'Arizona-AZ', 'AR-Arkansas', 'Arkansas-AR']);
        });
    });
});