...
describe("list manipulation", function () {
    describe("n_cons, n_head, n_tail, n_append, n_filter, listToArray, arrayToList", function () {
        ...
        it("filter a list - using odd", function () {
            ...
            (0, _chai.expect)(LA((0, _utils.n_filter)(_utils.odd, res))).to.deep.equal([1, 3, 5, 7, 9]);
        });
...
describe("Stack Opertations", function () {
    ...
    describe("n_reduce, n_removeall", function () {
        ...
        it("n_reduce", function () {
            ...
            var res = (0, _utils.n_reduce)(function (a, b) {
                return a + b;
            }, list1_to_5, 0);
            (0, _chai.expect)(res).to.equal(15);
            (0, _chai.expect)((0, _utils.n_reduce)(function (a, b) {
                return a + b;
            }, list1_to_5, "")).to.equal("12345");
        });
