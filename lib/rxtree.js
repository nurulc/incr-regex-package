...
function rxMatch(rxN, ch, lastCh) {
  var matchState = arguments.length <= 3 || arguments[3] === undefined ? new StackDedup() : arguments[3];
...
function advancedRxMatcher(rxN, str) {
  var state0 = rxMatch(rxN, str.charAt(0));
...
var RXTREE = exports.RXTREE = { MANY: MANY, TERM: TERM, PERHAPS_MORE: PERHAPS_MORE, BOUNDARY: BOUNDARY, matchable: matchable, boundary: boundary, dot: dot, or: or, zero_or_one: zero_or_one, zero_or_more: zero_or_more, anychar: anychar, charset: charset, OP: OP,
  ...
  RX_OP: RX_OP, RX_UNARY: RX_UNARY, RX_CONS: RX_CONS, RX_OR: RX_OR, RX_ZERO_OR_ONE: RX_ZERO_OR_ONE, RX_ZERO_OR_MORE: RX_ZERO_OR_MORE, RX_ONE_OR_MORE: RX_ONE_OR_MORE, copyNode: copyNode, stdRxMeta: stdRxMeta, makeCharSet: makeCharSet, makeFSM: makeFSM, rxMatchArr: rxMatchArr, rxNextState: rxNextState, rxMatch: rxMatch };