...
exports.IREGEX = exports.getArrayMask = undefined;
...
var _rxtree2 = _interopRequireDefault(_rxtree);
...
console.log(_rxtree2.default);
[["matchable", _rxtree.matchable], ["boundary", _rxtree.boundary], ["dot", _rxtree.dot], ["or", _rxtree.or], ["zero_or_one", _rxtree.zero_or_one], ["zero_or_more,", _rxtree.zero_or_more], ["MORE,", _rxtree.MORE], ["MAYBE,", _rxtree.MAYBE], ["makeFS", _rxtree.makeFSM], ["DONE,", _rxtree.DONE], ["FAILED,", _rxtree.FAILED]].map(function (e) {
...
function convertMask(s) {
  ...
  return s.split('').map(function (c) {
    return c === "*" ? _rxtree.HOLDER_ZERO_OR_MORE : c === "?" ? _rxtree.HOLDER_ZERO_OR_ONE : c === "_" ? _rxtree.HOLDER_ANY : c;
  }).join('');
}
