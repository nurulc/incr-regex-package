...
function logit(msg, val) {
  console.log("logit: " + msg);return val;
}
function convert(str) {
  ...
  if (/^\\[trn]$/.test(str)) return { type: 'N', val: chmap[str.substring(1, 2)], multi: _rxtree.TERM, op: 'NON-PRINTING', match: __match("\\" + str.substring(1)) };
